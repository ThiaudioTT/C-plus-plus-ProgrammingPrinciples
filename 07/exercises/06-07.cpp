...
class Symbol_table
{ // array user defined type to put variables names in it and its own functions used in calc.
public:
...
void printHelp()
{
    cout << "Welcome to the calculator" << endl
         << "Enter 'h' to see help page" << endl
         << "Enter 'quit' to quit" << endl
         << "Operations available: " << endl
         << "+ sum, - difference, * multiplication, / division and % remainder" << endl;
}
